      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-sm-4 col-xs-12">
            <div class="single_footer">
              ...
              <ul>
                <li><a href="#" style="color: #4a4a4a;">Tifa Arum Realty Lantai 7
                    Jl. Kuningan Barat 1 No.26, RT.6/RW.1
                    Kuningan Barat, Kec. Mampang Prapatan
                    Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12710. (021) 2708 2000
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="single_footer single_footer_address mt-4">
              <h4 style="color: #4a4a4a;">FINTAG</h4>
              <ul>
                <li>
          ...
          <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="single_footer single_footer_address  mt-4">
              <h4 style="color: #4a4a4a;">TENTANG KAMI</h4>
              <ul>
                <li>
                  <a href="#" style="color: #4a4a4a;">
                    Tentang Perusahaan
          ...
          <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="single_footer single_footer_address  mt-4">
              <h4 style="color: #4a4a4a;">LEGAL</h4>
        ...
        <div class="row mt-5">
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6">
                <img src="https://fintag.id/img/Fintag-OJK-Licensed.png" alt="">
              </div>
              <div class="col-md-6">
                <img src="https://fintag.id/img/Fintag-ISO-27001-Certified.png" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-4">
                <img src="https://fintag.id/img/Fintag-indonesia.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mt-5">
          <div class="col-md-12" style="color: #4a4a4a;">
        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <p class="copyright" style="color: #4a4a4a;">© 2023 <a href="#"></a>PT. Fintegra Homido Indonesia. All rights reserved.</p>
          </div>
          <!--- END COL -->
        </div>
        <!--- END ROW -->
